...
1. Clone repository (https://github.com/githubharald/CTCWordBeamSearch)
...
* Register for free at this (http://www.fki.inf.unibe.ch/databases/iam-handwriting-database)
